var f,h=this;function k(a){return void 0!==a}function m(a){return"string"==typeof a}function aa(){}
...
function Wc(a){ib(a.c(),a.j?a.s?1:.6:0)}f.update=function(){R.h.update.call(this);Vc(this);Wc(this)};f.H=function(){throw Error("Method not supported");};f.ya=function(){var a=this.c();Qc(a,this.A());z(a,Xc);z(this.w.b,Yc)};f.xa=function(){K(this.w,this.c())};f.B=function(){R.h.B.call(this);this.xa();this.ya()};f.za=function(a){this.j&&(a.stopPropagation(),G(this,"click"))};f.kb=function(a){this.j&&(a.stopPropagation(),this.s=!0,Wc(this))};f.lb=function(a){this.j&&(a.stopPropagation(),this.s=!1,Wc(this))};
f.o=function(){R.h.o.call(this);var a=kc(this);a.m(this.c(),"mousedown",this.za);a.m(this.c(),"mouseenter",this.kb);a.m(this.c(),"mouseleave",this.lb)};var Xc={position:"relative",transition:"opacity 0.125s linear"},Yc={position:"absolute",width:"100%",height:"100%",transition:"opacity 0.250s linear"};var Zc=Ja||Ha?"webkitfullscreenchange":Ia?"mozfullscreenchange":w?"MSFullscreenChange":"fullscreenchange";function $c(a){a=a?a.a:Ya().a;return!!(a.webkitIsFullScreen||a.mozFullScreen||a.msFullscreenElement||a.fullscreenElement)};function ad(a){O.call(this,a);this.Pa=!1}p(ad,O);f=ad.prototype;f.ib=function(){this.Pa=!0;null!==this.c()&&(this.a&&bd(this),z(this.b,{opacity:1,transition:"opacity 0.2s ease-in"}),G(this,"load"))};f.Za=function(){};
...
f.wa=function(a,b){switch(b.keyCode){case 37:Rd(this);break;case 39:Sd(this);break;case 122:this.N=!0;this.a&&od(this);b.preventDefault();break;case 80:this.s.b?ld(this):jd(this)}};f.jb=function(a){this.wa(a.keyCode,a)};f.hb=function(a){var b=a.index;a=this.da[b];(b=pc(this.b,b))&&!k(b.ma)&&(b.ma=a.src,b.update())};f.qb=function(){qd(this);nd(this)};f.ab=function(){this.N=$c(this.g);qd(this);nd(this)};f.ob=function(){Sd(this)};f.Da=function(){this.u.b?N(this.u):(this.K=!0,this.a&&this.O());this.u.start()};
f.Aa=function(){Rd(this)};f.Fa=function(){Sd(this);this.P.S&&ld(this)};f.Ea=function(){this.P.S?ld(this):jd(this)};f.bb=function(){this.N=!this.Y.S;this.a&&od(this)};f.pb=function(){fd(this,!this.M)};f.Xa=function(){this.K=!1;this.a&&this.O();N(this.u)};
f.o=function(){U.h.o.call(this);var a=kc(this);D(window.document,"keydown",this.jb,!1,this);D(this.b,"index",this.hb,!1,this);D(this.fb,"resize",this.qb,!1,this);D(window.document,Zc,this.ab,!1,this);D(this.s,"tick",this.ob,!1,this);a.m(this.c(),"mousemove",this.Da);a.m(this.oa,"click",this.Aa);a.m(this.ta,"click",this.Fa);a.m(this.P,"click",this.Ea);a.m(this.Y,"click",this.bb);a.m(this.ha,"click",this.pb);D(this.u,"tick",this.Xa,!1,this)};
...
W.prototype.update=function(){W.h.update.call(this);this.R.innerHTML=this.Oa;this.sa.la(this.tb?!0:!1)};var Zd=new Q("M10 8v8l5-4-5-4zm9-5H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14z",new y(-4,-4,32,32)),$d=new Q("M12 8V4l8 8-8 8v-4H4V8z",new y(-12,-12,48,48));f=W.prototype;
...
f.wa=function(a,b){W.h.wa.call(this,a,b);switch(b.keyCode){case 27:Vd(this,!1)}};f.$a=function(){Vd(this,!this.j)};f.Wa=function(){Vd(this,!1)};f.Ya=function(){Vd(this,!this.j)};f.Da=function(a){this.Na=!1;W.h.Da.call(this,a)};f.nb=function(){Vd(this,!0);Ud(this);jd(this)};f.Aa=function(a){W.h.Aa.call(this,a);Ud(this)};f.Fa=function(a){W.h.Fa.call(this,a);Ud(this)};f.Ea=function(a){W.h.Ea.call(this,a);Ud(this)};
f.o=function(){W.h.o.call(this);var a=kc(this);a.m(this.$,"click",this.nb);a.m(this.X,"click",this.$a);a.m(this.W,"click",this.Wa);a.m(this.c(),"dblclick",this.Ya)};
var ae={position:"absolute",top:0,left:0,width:"100%",height:"48px","padding-bottom":"50px","background-repeat":"repeat-x","background-image":"url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAADGCAYAAAAT+OqFAAAAdklEQVQoz42QQQ7AIAgEF/T/D+kbq/RWAlnQyyazA4aoAB4FsBSA/bFjuF1EOL7VbrIrBuusmrt4ZZORfb6ehbWdnRHEIiITaEUKa5EJqUakRSaEYBJSCY2dEstQY7AuxahwXFrvZmWl2rh4JZ07z9dLtesfNj5q0FU3A5ObbwAAAABJRU5ErkJggg==)",transition:"opacity .250s cubic-bezier(0.0,0.0,0.2,1)","pointer-events":"none","z-index":9},be=
...
{bottom:"8px",right:"72px"},je={left:"8px",top:"8px"};var ke=!w&&!Ca();function X(a,b){if(/-[a-z]/.test(b))return null;if(ke&&a.dataset){if(Ea()&&!(b in a.dataset))return null;a=a.dataset[b];return void 0===a?null:a}return a.getAttribute("data-"+String(b).replace(/([A-Z])/g,"-$1").toLowerCase())};function le(a){J.call(this,a)}p(le,J);le.prototype.H=function(a){le.h.H.call(this,a);this.a=new W;K(this.a,a)};function me(a,b){b.title&&Td(a.a,String(b.title));if(k(b.items)&&n(b.items)){var c=[];ma(b.items,function(a){c.push({src:a.image})});ed(a.a,c)}k(b.Ta)&&xc(a.a.s,1E3*(Number(b.Ta)||3));k(b.Ua)&&fd(a.a,!!b.Ua)}
le.prototype.b=function(a){var b={};b.title=q(a,"title","");b.items=[];var c=q(a,"items");n(c)&&ma(c,function(a){b.items.push({image:q(a,"image")})});b.Ta=q(a,"slideshowDelay",5);b.Ua=q(a,"slideshowRepeat",!0);me(this,b)};
function ne(a){if(!a.Va){a.Va=!0;var b={};b.link=String(X(a,"link"));b.title=String(X(a,"title"));b.desctiption=String(X(a,"desctiption"));b.slideshowDelay=Number(X(a,"slideshowDelay")||5);b.slideshowRepeat=!(X(a,"slideshowRepeat"),!1);for(b.items=[];a.firstChild;){var c=a.firstChild;if("IMG"==c.tagName){var d={};d.image=String(X(c,"src"));d.title=String(X(c,"title"));na(b.items,d)}a.removeChild(c)}c=X(a,"display");c||(d=parseInt(fb(a),10)||"480px",z(a,"min-height",d),z(a,"height",d));z(a,"display",
c?String(c):"block");console.log("PublicAlbum.org embed player `"+b.title+"` was decorated.");setTimeout(function(){oe(a,b)},0)}}function oe(a,b){var c=new le;if(c.v)throw Error("Component already rendered");if(a){var d=$a(a);c.g&&c.g.a==d||(c.g=Ya(a));c.H(a);c.o()}else throw Error("Invalid element to decorate");c.b(b);c.setProperties=c.b;return c}var pe=oe,qe=["EmbedPlayer"],Y=h;qe[0]in Y||"undefined"==typeof Y.execScript||Y.execScript("var "+qe[0]);
for(var Z;qe.length&&(Z=qe.shift());)!qe.length&&k(pe)?Y[Z]=pe:Y[Z]&&Y[Z]!==Object.prototype[Z]?Y=Y[Z]:Y=Y[Z]={};
ma(function(){var a=document;if(a.querySelectorAll&&a.querySelector)return a.querySelectorAll("DIV.pa-embed-player");if(a.getElementsByClassName){a=a.getElementsByClassName("pa-embed-player");for(var b={},c=0,d=0,e;e=a[d];d++)"DIV"==e.nodeName&&(b[c++]=e);b.length=c;return b}a=a.getElementsByTagName("DIV");b={};for(d=c=0;e=a[d];d++){var g=e.className,l;if(l="function"==typeof g.split)l=0<=la(g.split(/\s+/),"pa-embed-player");l&&(b[c++]=e)}b.length=c;return b}(),function(a){ne(a)});
